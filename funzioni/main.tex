...
\begin{document}
    ...
    \creativecommons
    \vspace{\fill}
    \hspace{\fill} v. 1.4   %incrementare primo numero per contenuti e secondo numero per patch
    \end{titlepage}
    ...
    \subsection{Monotonia}
        \begin{boxdef}[Funzione crescente in senso stretto]
        ...
        \end{boxdef}
        \begin{boxdef}[Funzione crescente in senso lato]
        ...
        \end{boxdef}
        \begin{boxdef}[Funzione decrescente in senso stretto]
        ...
        \end{boxdef}
        \begin{boxdef}[Funzione decrescente in senso lato]
        ...
        \begin{boxdef}[Funzione monotòna]
    ...
    \subsection{La funzione esponenziale}
        \begin{wrapfigure}[10]{r}{0.2\textwidth}
                \begin{tikzpicture}[scale = 0.5]
                    \begin{axis}[
                        x=1.0cm,y=1.0cm,
                ...
                \end{tikzpicture}
        \end{wrapfigure}
        La funzione esponenziale $y=a^x$ è una funzione trascendente. Essa ha dominio $\R$ e codominio $]0;+\infty[$, e presenta un asintoto orizzontale a $0$. Di conseguenza non ha zeri di funzione. Se $a>1$ La funzione è strettamente crescente, mentre se $0<a<1$ la funzione è strettamente decrescente. 
    ...
    \begin{wrapfigure}{r}{0.3\textwidth}
        ...
        \caption*{$f(x)=x^2-2x$}
    \end{wrapfigure}
    \subsubsection{Valore assoluto di una funzione}
    ...
    \subsubsection{Funzione di un valore assoluto}
